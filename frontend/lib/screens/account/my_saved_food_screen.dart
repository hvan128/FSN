...
class MySavedFoodScreen extends StatefulWidget {
  const MySavedFoodScreen({super.key});

  @override
  State<MySavedFoodScreen> createState() => _MySavedFoodScreenState();
}

class _MySavedFoodScreenState extends State<MySavedFoodScreen> {
  List<Dish> dishes = [];
  int? userId;
  int? total;
  String? type;
