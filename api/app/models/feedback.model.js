...
//     db.query(`SELECT COUNT(*) AS total FROM feedback WHERE dishId = ${dishId}`, (err, countResult) => {
//       if (err) {
//         console.log(err);
//         result(err, null);
//         return;
...
//       db.query(`SELECT * FROM feedback WHERE dishId = ${dishId} LIMIT ${pageSize} OFFSET ${offset}`, (err, res) => {
//         if (err) {
//           console.log(err);
//           result(err, null);
//           return;
...
//             db.query(`SELECT * FROM feel WHERE feedbackId = ${feedbackId}`, (err, feels) => {
//               if (err) {
//                 reject(err);
//               } else {
