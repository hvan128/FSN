...
export default function Alert() {
    ...
    useEffect(() => {
        const timeId = setTimeout(() => {
            // After 5 seconds set the open value to false
            dispatch(closeAlert());
        }, 5000)
                        ...
                        <div className="bg-support-c200 px-4 pb-4 sm:pt-2 xs:pt-2 pt-5">
                            <div className="sm:flex sm:items-start">
                                ...
                                <div className="md:mt-3 text-center sm:ml-4 sm:mt-0 xs:mt-0 sm:text-left">
                                    ...
                                    <div className="mt-2">
                                        <Typography fontSize={FontSize.BASE} fontFamily={FontFamily.SEMI_BOLD} textColor={TextColor.SUPPORT_800}>{data.message}</Typography>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-success-c50 px-4 pb-4 sm:pt-2 xs:pt-2 pt-5">
                        <div className="sm:flex sm:items-start">
                            ...
                            <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                ...
                                <div className="mt-2">
                                    <Typography fontSize={FontSize.BASE} fontFamily={FontFamily.SEMI_BOLD} textColor={TextColor.SUCCESS_800}>{data.message}</Typography>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-primary-c50 px-4 pb-4 sm:pt-2 xs:pt-2 pt-5">
                        <div className="sm:flex sm:items-start">
                            ...
                            <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                ...
                                <div className="mt-2">
                                    <Typography fontSize={FontSize.BASE} fontFamily={FontFamily.SEMI_BOLD} textColor={TextColor.PRIMARY_900}>{data.message}</Typography>
                                </div>
                            </div>
                        </div>
                    </div>
